...
if(RUNTIME_BUILD_ZLIB)
	...
	set(ZLIB_LIBRARIES "zlib"  CACHE INTERNAL "Local zlib library/project" FORCE)	
	set(ZLIB_INCLUDE_DIR ${ZLIB_INCLUDE_DIRS}  CACHE INTERNAL "Local zlib include directories" FORCE)
	set(ZLIB_LIBRARY ${ZLIB_LIBRARIES}  CACHE INTERNAL "Local zlib library/project" FORCE)
