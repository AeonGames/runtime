...
if(RUNTIME_BUILD_LIBPNG)
	...
	download("http://download.sourceforge.net/libpng/libpng-1.6.18.tar.gz" "libpng-1.6.18.tar.gz")
	decompress("libpng-1.6.18.tar.gz" "libpng-1.6.18")
	...
	add_subdirectory("${BUILD_DIRECTORY}/libpng-1.6.18" "${CMAKE_BINARY_DIR}/libpng-1.6.18")
endif()
